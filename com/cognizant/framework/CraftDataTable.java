...
public class CraftDataTable
{
	...
	private String getCommonData(String fieldName, String dataValue)
	{
		...
		String strDefaultLanguage = properties.getProperty("DefaultLanguage");
		ExcelDataAccess commonDataAccess = new ExcelDataAccess(datatablePath, "Common Testdata");
		
		// To get data from different common test data
		try{
			System.out.println("Getting test data from common test data "+strDefaultLanguage );
			commonDataAccess.setDatasheetName(strDefaultLanguage);
		}
		catch(Exception e){
			System.out.println("Unable to get test data from common test data "+strDefaultLanguage );
			System.out.println("===================================================================");
			System.out.println("Getting test data from common test data Common_Testdata");
